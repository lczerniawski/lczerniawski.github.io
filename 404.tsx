export const title = "Łukasz's Corner - Page not found";
  ...
  <>
      <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-6 text-base leading-7 text-gray-600 dark:text-slate-400">Sorry, we couldn’t find the page you’re looking for.</p>
