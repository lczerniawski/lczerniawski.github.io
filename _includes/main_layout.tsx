  ...
  return (
    <html class="h-full">
      ...
      <body class="h-full flex flex-col items-center font-sans dark:bg-gray-900">
        ...
        <button onClick="toggleTheme()" class="fixed bottom-4 right-4 px-2 py-2 bg-orange-600 text-white rounded-lg shadow-lg hover:bg-orange-500 focus:outline-none">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
